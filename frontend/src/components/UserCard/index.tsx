...
export default function UserCard({ username, userID, profilePicURL }: {username: string, userID: number, profilePicURL: string}) {
  ...
  return (
    <div className="h-32 w-56 text-black rounded-lg bg-white cursor-pointer shadow-md hover:scale-110 hover:shadow-purple-300 hover:shadow-xl transition-all"
